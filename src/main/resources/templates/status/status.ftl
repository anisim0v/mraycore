    ...
    <div class="container">
        ...
        <div>
            ...
            <#elseif account.familyToken??>
                Подписка оплачена до ${account.activeUntil!"конца времен"}. Приглашение было отправлено на почту.
            <#elseif !isActive>
                Подписка не оплачена
            <#else>
                Подписка активна, но токен не присвоен. Если вы не знаете, почему так произошло – обратитесь в поддержку.
            </#if>
        </div>
        <#if showRenewForm>
            <br>

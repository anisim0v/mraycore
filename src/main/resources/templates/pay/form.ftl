        ...
        <#if !account.familyToken??>
            <div>
                ...
                <#else>
                    ...
                    одним из первых (в порядке очереди среди оплативших) получите приглашение в семью.<br><br>
                    Не забывайте, что мы регистрируем семьи на те деньги, которые получаем от вас. В случае чего вы всегда
                    можете запросить возврат денег, просто написав в поддержку.<br><br>
